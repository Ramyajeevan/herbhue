      ...
      <div class="card">
        <div class="card-body">
          ...
          <input type="hidden" id="total_options" name="total_options" value="{{ count($productoptions) }}">
            ...
            <div class="mb-3 row">
                <label class="col-md-2 col-form-label" for="series">Series Name</label>
                <div class="col-md-10">
                  <input class="form-control" name="series" id="series" type="text"  value="{{ $product->series }}" placeholder="Enter series Name">
                </div>
            </div>
            <div class="mb-3 row">
