<?php $__env->startSection('content'); ?>
   ...
   <div class=" border-0 shadow  bg-transparent">
        <div class="card-body d-flex justify-content-between">
            <h5> <a href="#" class="text-dark">APPLICATIONS</a>   </h5>
    ...
    <div class="card border-0 shadow mt-4 bg-transparent ">
        <div class="card-body">
            ...
            <div id="filterwaladiv22">
                ...
                <label class="btn btn-outline-primary btn-sm me-2" for="danger-outlined2">Close</label>
            </div>
                ...
                <table class="table table-bordered border-top border-start small" id="myTable">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="bg-primary text-white">Transaction type</th>
                    ...
                    <tbody>
                      ...
                      <!--  <td>  <span class="mx-2">||</span>
                            <span data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="bx bx-edit-alt text-primary me-1 cursor-pointer edit-customer"  data-bs-toggle="modal" data-bs-target="#basicModal" ></i></span>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td>
                            <span class="badge bg-light-warning text-dark p-2">Open</span>
                        </td>
                      <!--  <td>  <span class="mx-2">||</span>
                            <span data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="bx bx-edit-alt text-primary me-1 cursor-pointer edit-customer"  data-bs-toggle="modal" data-bs-target="#basicModal" ></i></span>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td>
                            <span class="badge bg-light-success text-dark p-2">Close</span>
                        </td>
                      <!--  <td>  <span class="mx-2">||</span>
                            <span data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="bx bx-edit-alt text-primary me-1 cursor-pointer edit-customer"  data-bs-toggle="modal" data-bs-target="#basicModal" ></i></span>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppp\htdocs\kyc-app\resources\views/admin/application.blade.php ENDPATH**/ ?>