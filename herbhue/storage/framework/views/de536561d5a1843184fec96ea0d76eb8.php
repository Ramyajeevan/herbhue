        ...
        <div class="row mt-4">
            <div class="col-md-4">
                <div class="card shadow border-3 mb-5 border-secondary">
                    <div class="card-body">
                        <div class="d-flex">
                            <img src="<?php echo e(asset('img/Group 45.png')); ?>" width="60px" class="me-2" alt="">
                            <div>
                                <h6>Hello ,</h6>
                ...
                <div class="card shadow border-3 border-secondary">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item py-3">
                            <div class="row">
                                <div class="col-3">
                                    <img src="<?php echo e(asset('img/inventory_2_FILL1_wght400_GRAD0_opsz48.png')); ?>" width="30px" alt="">
                                </div>
                                <div class="col-6">
                                    <h5>My Orders</h5>
                                </div>
                                ...
                                <div class="col-3 text-end">
                                    <img src="<?php echo e(asset('img/arrow_forward_ios_FILL1_wght400_GRAD0_opsz48.svg')); ?>" width="10px" alt="">
                                </div>
                        ...
                        <li class="list-group-item py-3">
                            <div class="row">
                                <div class="col-3">
                                    <img src="<?php echo e(asset('img/location_on_FILL1_wght400_GRAD0_opsz48.png')); ?>" width="30px" alt="">
                                </div>
                                <div class="col-6">
                                    <h5>My Addresses</h5>
                                </div>
                        ...
                        <li class="list-group-item py-4">
                            <div class="row">
                                <div class="col-3">
                                    <img src="<?php echo e(asset('img/shopping_cart_FILL1_wght400_GRAD0_opsz48 (3) (1).svg')); ?>" width="30px" alt="">
                                </div>
                                <div class="col-6">
                                    <h5>My Cart</h5>
                                </div>
                        ...
                        <li class="list-group-item py-3">
                            <div class="row">
                                <div class="col-3">
                                    <img src="<?php echo e(asset('img/favorite_FILL1_wght400_GRAD0_opsz48 (2) (1).svg')); ?>" width="30px" alt="">
                                </div>
                                <div class="col-6">
                                    <h5>My Wishlist</h5>
                                </div>
                        ...
                        <li class="list-group-item py-3">
                            <div class="row">
                                <div class="col-3">
                                    <img src="<?php echo e(asset('img/contact_page_FILL1_wght400_GRAD0_opsz48 (1).svg')); ?>" width="30px" alt="">
                                </div>
                                <div class="col-6">
                                    <h5>Contact Us</h5>
                                </div>
                        ...
                        <li class="list-group-item py-3">
                            <div class="row">
                                <div class="col-3">
                                    <img src="<?php echo e(asset('img/logout_FILL1_wght400_GRAD0_opsz48 (1).svg')); ?>" width="30px" alt="">
                                </div>
                                <div class="col-6">
                                    <h5>Log Out</h5>
                                </div>
                ...
                <div class="card shadow border-secondary border-3">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-3 text-end">
                                <img src="<?php echo e(asset('img/drive_file_rename_outline_FILL1_wght400_GRAD0_opsz48.svg')); ?>" width="20px" data-bs-toggle="modal" data-bs-target="#exampleModal" alt="">
                            </div>
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\hurbhue\resources\views/frontend/accountpage.blade.php ENDPATH**/ ?>