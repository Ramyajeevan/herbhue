...
<div class="container-fluid">
 ...
 <div class="text-end mt-5">
    <button type="button" class="btn btn-success w-50 py-2 h5 fw-bold"> Add  <img src="img/add_circle_FILL1_wght400_GRAD0_opsz48 (1).svg" style="width: 25px; position: relative;
        top: -3px;
        left: 3px;" alt=""></button>
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\herbhue\resources\views/frontend/wishlist.blade.php ENDPATH**/ ?>