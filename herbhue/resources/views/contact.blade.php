                ...
                <div class="card shadow border-20px border-0 p-3" style="margin-top:-115px ;">
                    <div class="card-body">
                        <form method="post" action="{{ route('contactus') }}">
                            ...
                            @endif
                            <div class="mb-3">
                                <input type="text" class="form-control form-control-lg bg-secondary border-0 rounded-0" id="name" name="name" required placeholder="Enter your name">
                            </div>
                            <div class="mb-3">
                                <input type="email" class="form-control form-control-lg bg-secondary border-0 rounded-0" id="email" name="email" required placeholder="Enter your email address">
                            </div>
                            <div class="mb-3"> 
                                 <textarea class="form-control form-control-lg bg-secondary border-0 rounded-0" id="message" name="message" rows="3" placeholder="Go ahead, we are listing..." required></textarea>
                            </div>
