            ...
            <div class="col-lg-4">
                ...
                <div class="text-center mb-5">
                   ...
                   width="15px" alt=""> +44</span> 
                    <input type="text" class="form-control"  id="mobile" name="mobile" onkeypress="return onlyNumberKey(event);" maxlength = "10" aria-describedby="basic-addon1" required placeholder="Phone No.">
                    </div>
                    <!-- <div class="form-group">
