function addOption()
		{
			...
			var selecttag="";
			  ...
			  cell3.innerHTML='<input type="text" name="opt_price_'+optionNum+'" id="opt_price_'+optionNum+'" class="form-control decimal" required>';
			  cell4.innerHTML='<input type="text" name="opt_mrp_price_'+optionNum+'" class="form-control decimal" required>';
