            ...
            <tbody>
              ...
              @foreach ($subcategory as $subcat)
                <tr>
                  ...
                  <td>{{ $subcat->name }}</td>
                  <td><img src="{{URL::asset('/images/')}}/{{$subcat->image}}" width="100" height="100" alt=" {{ $subcat->image }}"></td>
                  <td>
                    <a  href="{{route('subcategory.edit',$subcat->id)}}"  class="btn btn-sm text-primary border-primary" data-original-title="Edit Category">
                      <i data-feather="edit-3"></i>
                    </a>
                    <a href="javascript:void(0);" onclick="deletesubcategory({{$subcat->id}})"  class="btn btn-sm text-danger border-danger" data-original-title="Delete">
