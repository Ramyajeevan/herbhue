    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="form" enctype="multipart/form-data" action="{{route('coupon.update',$coupon->id)}}" method="post">
          @csrf
            <div class="mb-3 row">
              <label for="name" class="col-md-2 col-form-label">Coupon Name</label>
              <div class="col-md-10">
                <input class="form-control" type="text" id="name" name="name"  value="{{$coupon->name}}" placeholder="Enter Coupon name" required/>
              </div>
            </div>
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
                  <div class="form-check form-check-inline">
                      <div class="custom-control custom-radio">
                          <input type="radio" class="custom-control-input" id="amount" value="Amount" <?php if($coupon->coupon_type=="Amount") { ?> checked <?php } ?>  name="coupon_type">
                          <label class="custom-control-label" for="amount">Amount</label>
                      </div>
                  </div>
                  <div class="form-check form-check-inline">
                      <div class="custom-control custom-radio">
                          <input type="radio" class="custom-control-input" id="percent" value="Percent" <?php if($coupon->coupon_type=="Percent") { ?> checked <?php } ?>  name="coupon_type">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
                <input class="form-control" type="date" id="valid_from" name="valid_from" placeholder="Enter Valid From Date" value="{{$coupon->valid_from}}" readonly/>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="valid_to" class="col-md-2 col-form-label">Valid To</label>
              <div class="col-md-10">
                <input class="form-control" type="date" id="valid_to" name="valid_to" placeholder="Enter Valid To Date" value="{{$coupon->valid_to}}" min="<?php echo date("Y-m-d"); ?>" required/>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="valid_to" class="col-md-2 col-form-label">Amount/Percentage</label>
              <div class="col-md-10">
                <input class="form-control" type="text" id="amount" name="amount" placeholder="Enter  Coupon Amount"  value="{{$coupon->amount}}" required/>
              </div>
            </div>
            <div class="mb-3 row">
