    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="form" enctype="multipart/form-data"  action="{{route('blog.store')}}" method="post">
          @csrf
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
                <textarea class="form-control"  id="description" name="description" placeholder="Enter Blog description" required></textarea>
              </div>
            </div>
