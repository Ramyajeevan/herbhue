            ...
            <tbody>
              ...
              @foreach ($product as $prod)
                <tr>
                  ...
                  <td>{{ $prod->name }}</td>
                  <td><img src="{{ URL::asset('images/'.$prod->image1) }}" width="200" height="100"  alt="{{ $prod->image1 }}"></td>
                  <td>
                    <a href="{{route('product.edit',$prod->id)}}"  class="btn btn-sm text-primary border-primary" data-original-title="Edit Product">
                      <i data-feather="edit-3"></i>
                    </a>
                    <a href="javascript:void(0);" onclick="deleteproduct({{$prod->id}})" class="btn btn-sm text-danger border-danger" data-original-title="Delete">
