        ...
        <div class="card-body">
          ...
          <div class="mb-3 row">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-5">
                <textarea name="recommendation1" id="recommendation1" class="form-control" required>{{ $recommendations->recommendation1 }}</textarea>
              </div>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-5">
                <textarea name="recommendation2" id="recommendation2" class="form-control">{{ $recommendations->recommendation2 }}</textarea>
              </div>
              <div align="center" class="col-md-5">
                <div class="input-group mb-3">
                  <span class="input-group-text">Upload</span>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-5">
                <textarea name="recommendation3" id="recommendation3" class="form-control">{{ $recommendations->recommendation3 }}</textarea>
              </div>
              <div align="center" class="col-md-5">
                <div class="input-group mb-3">
                  <span class="input-group-text">Upload</span>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-5">
                <textarea name="recommendation4" id="recommendation4" class="form-control">{{ $recommendations->recommendation4 }}</textarea>
              </div>
              <div align="center" class="col-md-5">
                <div class="input-group mb-3">
                  <span class="input-group-text">Upload</span>
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-5">
                <textarea name="recommendation5" id="recommendation5" class="form-control">{{ $recommendations->recommendation5 }}</textarea>
              </div>
              <div align="center" class="col-md-5">
                <div class="input-group mb-3">
                  <span class="input-group-text">Upload</span>
