  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="border-bottom title-part-padding">
        <h4 class="card-title mb-0">Newsletter List</h4>
      </div>
      <div class="card-body">
            ...
            <tbody>
              ...
              @foreach ($emails as $email)
                <tr>
                  ...
                  <td>{{ $email->email }}</td>
                  <td>
                    <a href="javascript:void(0);"  onclick="deletenewsletter({{$email->id}})" class="btn btn-sm text-danger border-danger" data-original-title="Delete">
              ...
              @else
              <tr>
                  <td colspan='3' align="center">No Newsletter Found</td>
              </tr>
              @endif
            </tbody>
