    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="form" enctype="multipart/form-data"  action="{{route('newsletter.send')}}" method="post">
          @csrf

            <div class="mb-3 row">
              <label class="col-md-2 col-form-label" for="emails">Email</label>
              <div class="col-md-10">
                  <select name="emails[]" id="emails" class="form-select" multiple required>
                    <option value="">Select Multiple Emails</option>
