            ...
            <tbody>
              ...
              @foreach ($categories as $brand)
                <tr>
                  <td>{{ ($loop->index)+1 }}</td>
                  <td>{{ $brand->name }}</td>
                  <td><img src="{{URL::asset('/images/')}}/{{$brand->image}}" width="100" height="100" alt=" {{ $brand->image }}"></td>
                  <td>
                    <a href="{{route('brand.edit',$brand->id)}}"  class="btn btn-sm text-primary border-primary" data-original-title="Edit Brand">
                      <i data-feather="edit-3"></i>
                    </a>
                    <a href="javascript:void(0);" onclick="deletebrand({{$brand->id}})" class="btn btn-sm text-danger border-danger" data-original-title="Delete">
              ...
              @else
              <tr>
                  <td colspan='4' align="center">No Brand Found</td>
              </tr>
              @endif
            </tbody>
