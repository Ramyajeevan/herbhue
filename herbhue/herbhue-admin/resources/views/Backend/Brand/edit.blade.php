    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="form" enctype="multipart/form-data" action="{{route('brand.update',$brand->id)}}" method="post">
          @csrf
            <div class="mb-3 row">
              <label for="name" class="col-md-2 col-form-label">Brand Name</label>
              <div class="col-md-10">
                <input class="form-control" type="text" id="name" name="name" placeholder="Enter Brand name" value="{{ $brand->name }}" required/>
              </div>
            </div>
            <div class="mb-3 row">
              <label class="col-md-2 col-form-label" for="image">Brand Image</label>
              <div class="col-md-10">
