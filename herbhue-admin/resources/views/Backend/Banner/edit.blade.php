    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form class="form" enctype="multipart/form-data"  action="{{route('banner.update',$banner->id)}}" method="post">
          @csrf

            <div class="mb-3 row">
              <label class="col-md-2 col-form-label" for="image">Banner Image</label>
              <div class="col-md-10">
                  <div class="input-group mb-3">
                      <span class="input-group-text">Upload</span>

                      <div class="custom-file" style="width:92.75%;">
                        <input type="file" class="form-control" id="image" name="image" placeholder="Enter Banner Image" required>
                      </div>
                    </div>
              </div>
            </div>
